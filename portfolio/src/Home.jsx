...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      description:
        "A full-stack food delivery platform with real-time order tracking, payment integration, and restaurant management dashboard.",
    ...
    },
    {
      ...
      description:
        "Real-time weather application with 5-day forecasts, location detection, and interactive maps using weather API.",
    ...
    },
    {
      ...
      title: "Netflix Clone",
      description:
        "Streaming platform clone with user authentication, video playback, and personalized recommendations.",
    ...
    },
    {
      ...
      description:
        "Simple Portfolio using React and Tailwind CSS to showcase my projects, experience, and contact links.",
    ...
    },
    {
      ...
      description:
        "A web app to manage college fest events — organizers can create events, and students can browse and register.",
      image: "https://i.postimg.cc/LXPLxdvH/Screenshot-2025-07-31-162945.png",
      tags: ["React", "Supabase", "Tailwind CSS"],
      liveUrl: "https://event-chi-seven.vercel.app/", // Fill in your live demo URL
      githubUrl: "https://github.com/Ragul198/Event", // Fill in your GitHub repo URL
    },
  ];
  ...
  const workExperience = [
    ...
    },
    {
      ...
      duration: "2023 - 2023",
      description:
        "Developed multiple fullstack applications to master web development technologies and best practices at Nanlogical Solutions Pvt. Ltd 1 month remote Web Development Internship.",
    ...
    },
    {
      ...
      duration: "2020 - 2022",
      description:
        "Developed multiple fullstack applications to master web development technologies and best practices.",
            ...
            <div className="z-10 animate-fade-in">
              ...
              <div className="mb-8">
                <p className="text-lg text-gray-300 mb-4 leading-relaxed">
                  A passionate fullstack developer specializing in the MERN
                  stack. I build robust, scalable web applications with clean
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="https://drive.google.com/uc?export=download&id=1GERqcQOEnCeDJyUvufrrQJorHSh3Prua"
                  rel="noopener noreferrer"
                >
                  <button className="bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-3 rounded-full hover:scale-105 transition-transform duration-300 font-semibold flex items-center justify-center space-x-2">
                  ...
                  <div className="relative">
                    <div className="w-80 h-80 mx-auto relative">
                      ...
                      <div className="absolute inset-2 bg-slate-900 rounded-xl overflow-hidden flex items-center justify-center">
                        <img
                          src="https://i.postimg.cc/JzwJ5vcj/Screenshot-2025-01-03-160257.png"
                          alt=""
                        />
                      </div>
                    </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {workExperience.map((work, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-lg bg-gradient-to-r ${work.color} mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                >
                  <Code className="w-6 h-6 text-white" />
                </div>
      ...
      <section id="contact" ref={contactRef} className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12">
            Interested in working together or have questions about my work? Feel
            free to reach out!
          </p>
          ...
          <div className="flex justify-center space-x-6 mb-12">
            {[
              {
                icon: Github,
                href: "https://github.com/Ragul198",
                label: "GitHub",
              },
              {
                icon: Linkedin,
                href: "https://www.linkedin.com/in/ragul-a-190820030and7032004/",
                label: "LinkedIn",
              },
              {
                icon: Mail,
                href: "mailto:ragul198a@gmail.com",
                label: "Email",
              },
            ].map((social) => (
              <a
          ...
          <p className="text-gray-400">ragul198a@gmail.com</p>
        </div>
      </section>
